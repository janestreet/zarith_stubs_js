...
module Ml_z_divisible = struct
  let%expect_test "print x, y, divisible x y" =
    ...
    [%expect
      {|
      ((hash 6505140a50f6be8c19d753b5bc9d0078) (uniqueness_rate 96.529814)) |}]
  ;;
end
...
module Ml_z_congruent = struct
  ...
  let%expect_test "print x, y, z, congruent x y z" =
    ...
    [%expect
      {|
      ((hash f7b829847eeeab5c6bada69e8ec6905d) (uniqueness_rate 96.934116)) |}]
  ;;
end
...
module Ml_z_remove = struct
  ...
  let%expect_test "print x, y, remove x y" =
    ...
    [%expect
      {|
      ((hash 31785be785de93844f221901a25a0b5f) (uniqueness_rate 96.529814)) |}]
  ;;
end
