...
module Ml_z_jacobi = struct
  let%expect_test "print x, y, jacobi x y" =
    ...
    [%expect
      {|
      ((hash cd1cadf3e1014c37df027be2d6cfdc37) (uniqueness_rate 96.089932)) |}]
  ;;
end
...
module Ml_z_legendre = struct
  let%expect_test "print x, y, legendre x y" =
    ...
    [%expect
      {|
      ((hash 00f3ba8c7b418e70c4311a972509d7d5) (uniqueness_rate 96.089932)) |}]
  ;;
end
...
module Ml_z_kronecker = struct
  let%expect_test ("print x, y, kronecker x y"[@tags "no-js"]) =
    ...
    [%expect
      {|
      ((hash 5e20979fff7d0cdacebdaf949ad2a9cf) (uniqueness_rate 96.529814)) |}]
  ;;
end
...
module Ml_z_bin = struct
  let%expect_test "print x, y, bin x y" =
    ...
    [%expect
      {|
      ((hash e9550b72915b41a5e8e84150d82c3cda) (uniqueness_rate 85.742188)) |}]
  ;;
end
